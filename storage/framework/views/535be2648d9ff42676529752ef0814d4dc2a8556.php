      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right wrapper-test" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
            <a
              href="<?php echo e(route('vp-dashboard')); ?>"
              class="list-group-item list-group-item-action <?php echo e((request()->is('vp')) ? 'active' : ''); ?> "
              >Dashboard</a
            >

            <a
              href="<?php echo e(route('request-vp.index')); ?>"
              class="list-group-item list-group-item-action <?php echo e((request()->is('vp/request-vp*')) ? 'active' : ''); ?>"
              >Permintaan</a
            >
...
<?php /**PATH /var/www/lahan/resources/views/layouts/vp.blade.php ENDPATH**/ ?>